...
public class H2 implements SlideComponent {
    ...
    public View getView(Context context) {
        int textSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 12, context.getResources().getDisplayMetrics());
